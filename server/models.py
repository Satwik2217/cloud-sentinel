...
class Action(BaseModel):
    # Literal ensures the AI only chooses from these three specific strings
    command: Literal["terminate", "encrypt", "revoke_access"] = Field(
        ..., 
        description="Action to take: 'terminate', 'encrypt', or 'revoke_access'"
    )
...
# 5. This is the "Reward" object (Mainly for API documentation)
